...
public class EventFactory {
	...
	public static Event getEvent(Map<String, String> info) {
		...
		e.setEnded_at(getDate(info, "ended_at"));
	 ...
	 */
	// do private
	public static Date getDate(Map<String, String> info, String key) {
		Date value = null;
	...
	public static void main(String[] args) {
		...
		String key = "started_at";
		info.put(key, "2010-11-26T14:00:00+09:00");
		Date date = getDate(info, key);
